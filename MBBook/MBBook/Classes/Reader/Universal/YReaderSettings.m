...
- (UIImage *)getThemeImageWith:(YReaderTheme)theme {
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        imageArr = @[@"water_mode_bg",@"pink_mode_bg",@"green_mode_bg",@"sheepskin_mode_bg",@"violet_mode_bg",@"yellow_mode_bg",@"weekGreen_mode_bg",@"weekPink_mode_bg",@"coffee_mode_bg",@"blackGreen_mode_bg"];
    });
